...
public class Application {
	...
	public static void main(String[] args) {
		...
		emailSender.sendEmail("test", "Hello World!", "gepatytich@gmail.com");

		System.out.println(emailSender == context.getBean(EmailSender.class)); // каждый новый вызов не приводит к созданию нового объекта этого класса

		// Scope - [Singleton, Prototype, | Session, Request, ...]
		System.out.println("Singleton #1 = " + context.getBean(Singleton.class).getId()); // 1
		System.out.println("Singleton #2 = " + context.getBean(Singleton.class).getId()); // 1
		System.out.println("Singleton #3 = " + context.getBean(Singleton.class).getId()); // 1
